...
| 2021.05.13 | SecurityConfig /api/** permit 에서 사용하는 api만 permit 으로 fit - [김남석] <br/> 검색 필터 오류(online,offline 둘다 되는 경우 total일 경우에만 나타나는 현상) fit - [김남석] |
| 2021.05.13 | start.sh log파일 생성하도록 변경 - [고성빈] |